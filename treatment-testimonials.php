...
<body id="body" data-spy="scroll" class="demo-lightbox-gallery header-fixed page">
    ...
    <main class="wrapper page no-banner">
        ...
        <div class="container-fluid content">
            <div class="col col-md-6 col-sm-12">
                ...
                <div class="responsive-video">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/Y97ZVMbs6YU" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
            <div class="col col-md-6 col-sm-12 hidden-xs">
                <div class="responsive-video">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/vb0a1JnABYA" frameborder="0" allowfullscreen></iframe>
                </div>
                <div class="responsive-video">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/8_evBCMSOqk" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
            <div class="col col-sm-12">
                <h3 class="text-center margin-top-20">Take a look at more of our videos</h3>
                <h4 class="text-center margin-top-20 ">
            <a href="https://www.youtube.com/user/ibogainealternative" target="_blank">https://www.youtube.com/user/ibogainealternative</a>
                </h4>
            </div>
        </div>
        <!--=== End Content Part ===-->
