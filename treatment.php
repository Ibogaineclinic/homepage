<?php /* Template Name: treatment page */ ?>
    ...
    <head>
        <title>Ibogaine Clinic | Ibogaine Ibogaine Treatment</title>

        <!-- Meta -->
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=Edge">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="Ibogaine Clinic Ibogaine Treatment, get your life back today">
    ...
    <body id="body" data-spy="scroll" class="demo-lightbox-gallery header-fixed page">
        ...
        <main class="wrapper page">
            ...
            <div class="container content">
                ...
                <div class="col-xs-12 col-md-6">
                    <h3>Ibogaine Treatment Preparation</h3> Before the intitial Ibogaine treatment, two hours are spent interviewing the patient. It’s an inquiry of his/her journey with the drugs and their addiction history. All the patients have a different answer and as a result their actual problem is different. In many cases, depression attracts people towards addictive behavior and they try to reroute their attention from their real issue. David makes it clear this feeling of complete health and happiness through a addiction, is highly temporary.
                </div>
                <div class="col col-xs-12">
                    <h3>No Two Ibogaine experiences are the same</h3> David Dardashti wants to emphasize that each patient gets a personalized experience. You are the one who decides to fix your life; the treatment process takes you the right direction for your goals.
            ...
            <form method="post" id="sky-form3" class="sky-form" action="//formspree.io/inquiry@ibogaineclinic.com">
                <input type="hidden" name="_next" value="ibogaineclinic.com/ibogaine-treatment/#contact-us" />
