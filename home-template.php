...
<body id="body" data-spy="scroll" class="demo-lightbox-gallery header-fixed">
    ...
    <main class="wrapper page">
        ...
        <section class="intro-section">
            <section id="feature2" data-type="background" data-speed="5">
                ...
                <article class="container ">
                    ...
                    <h2 class="">by David Dardashti</h2>
        ...
        <section class="container-fluid">
            <div class="row no-space-pricing-v6 equal-height-columns-v3">
                <div class="panel panel-green margin-bottom-10 text-center col-sm-12 col-md-4 equal-height-column-v3">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-tasks"></i> All treatments include</h3>
                    </div>
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr>
                                <td>Free Unlimited High Speed Wifi throughout the facility</td>
                            </tr>
                            <tr>
                ...
                <div class="col-md-8 col-xs-12 equal-height equal-height-column-v3">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 col-width-full">
                        <div class="pricing-table-v6">
                            <div class="service-block service-block-dark-blue g-bg-aqua">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 col-width-full">
                        <div class="pricing-table-v6">
                            <div class="service-block service-block-green g-bg-green">
                    ...
                    <h5>*The second main Ibogaine treatment is optional or required if deemed necessary </h5>
                </div>
...
<!--
    ...
    <script src="//ibogaineclinic.com/wp-content/themes/BootstrapWP-child/assets/js/video.js"></script>
