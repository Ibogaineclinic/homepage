<?php /* Template Name: amenities page */ ?>
    <!DOCTYPE html>
    ...
    <head>
        <title>Amenities - Ibogaine Clinic | Treated 3,000+ patients - 2004</title>
...
-->
    ...
    <body id="body" data-spy="scroll" class="demo-lightbox-gallery header-fixed page">
        ...
        <main class="wrapper page">
            ...
            <div class="interactive-slider-v2 img-amenities">
                <div class="container">
                    <h2>Amenities in Playa Del Carmen</h2>
            ...
            <div class="container content">
                <div class="col col-md-6 col-sm-12">
                    <h1>Playa Del Carmen Resort</h1> We are proud to offer an enormous number of amenities within our resort. Clients purchasing any package have access to a huge number of different activities, which they can arrange to pay for and participate in. Platinum clients even have many amenities already included in their package! There are also miles and miles of soothing, sunlit beaches. They’re all within easy walking distance of the resort, and they’re all free to enjoy. Whether you choose to participate in all of the activities or none of them, we will do everything we can to make your experience at our facility an enjoyable one.
                    <h2>Recreational Activities</h2> All of these fantastic activities are available within walking distance of the resort. Besides the main reason for your stay, you can… • Swim with dolphins in the clear Caribbean waters • Snorkel and scuba dive around nearby reefs • Fish from the shoreline or from a ship • Take boat tours in and around Playa Del Carmen • Golf (golf cart rentals are also available) • Work out at a fully equipped gym • Participate in yoga classes. • Get a relaxing massage • Visit the local caverns or the Cedam museum. • Enjoy shopping at local souvenir stands. • Delight in a wonderful meal in nearby restaurants and coffee shops.
                </div>
                <div class="col col-md-6 col-sm-12">
                    <div class="responsive-video">
                        <iframe src="https://player.vimeo.com/video/113748341" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <!--=== End Content Part ===-->
