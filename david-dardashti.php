...
-->
    ...
    <body id="body" data-spy="scroll" class="demo-lightbox-gallery header-fixed page">
        ...
        <main class="wrapper page">
            ...
            <div class="interactive-slider-v2 img-ibogaine-molecule">
                <div class="container">
                    <h2>Ibogaine Treatment and Wellness Center</h2>
